  ...
  return (
    <>
        ...
        <div className="nav-left flex items-center">
          <div className="nav-logo">
            <Link to="/">
              ...
              Edu<span className="text-[#006dca]">via</span>
              </h1>
            </Link>
          </div>

          <ul className="hidden xl:flex gap-8 items-center ms-20 nav-menu" onClick={() => window.scrollTo(0, 0)}>
            <li>
      ...
      <div className={`sidebar overflow-y-scroll ${isOpen ? "active" : ""}`}>
        ...
        <ul className="flex gap-6 items-start flex-col pt-10 w-full" onClick={() => setIsOpen(false)}>
          <li className="w-full">

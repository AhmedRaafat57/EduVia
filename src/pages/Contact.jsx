    ...
    <>
      <div className="section-banner bg-[#f3f9ff] h-[400px] py-[50px] lg:py-[90px] flex flex-col justify-center items-center relative">
        ...
        <img
          src={element1}
          alt="shape-image"
          className="element1 w-[50px] shape1 absolute left-30 top-30 object-contain hidden md:block"
        />
        <img
          src={element2}
          alt="shape-image"
      ...
      <div className="flex justify-center items-center flex-col gap-10 px-[2%] lg:px-[12%] sm:px-[8%] py-[70px] lg:py-[120px] relative">
        ...
        <img
          src={element1}
          alt="shape-image"
          className="element1 w-[100px] hero-shape1 absolute left-30 top-30 object-contain hidden md:block"
        />
        <img
          src={element2}
          alt="shape-image"
